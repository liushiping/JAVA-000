...
public class NewUserLogic {
    ...
    public static final String JDBC_URL = "jdbc:mysql://localhost:3306/ds?rewriteBatchedStatements=true&characterEncoding=utf-8&serverTimezone=UTC";
    ...
    public static void addExecuteBatch(int number) {
        ...
        try {
            ...
            for (int i=0;i<sum;i++) {
                ...
                ps.setString(4, "13976578765");
                ps.setString(5, "test@163.com");
                ps.setString(6, "张三");
                ps.setString(7, "110101199509090001");
                ps.setString(8, "110101");
                ps.setInt(9, 0);
                ps.setString(10, "北京市东城区景山前街4号");
                ps.addBatch();
                if(i!=0 && i%size == 0){
                    //提交事务
                    conn.commit();
